<script lang="ts">
    ...
    const variants = {
        ...
        secondary: 'bg-stone-800 text-stone-200 hover:bg-stone-700 active:scale-[0.98]',
        outline: 'border border-stone-700 text-stone-300 hover:bg-stone-800 hover:border-stone-600 active:scale-[0.98]',
