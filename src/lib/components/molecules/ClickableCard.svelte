...
<button
    type="button"
    {disabled}
    class="group relative flex w-full items-start bg-anthracite/40 transition-all duration-150 border border-stone-800/20 text-left outline-none focus-visible:ring-2 focus-visible:ring-sapphire/50 disabled:opacity-50 disabled:cursor-not-allowed
