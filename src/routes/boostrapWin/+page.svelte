            ...
            {#each elements as el}
                    ...
                    >
                        {#if el.props.Title}
                            <span
                                ...
                                style="color:{rootFg};opacity:0.7"
                            >
                                {el.props.Title}
                            </span>
                        {/if}
                        <div class="flex items-center gap-1 ml-auto">
                            {#if el.props.ShowMinimize === 'True'}
                                <button
                                    ...
                                    style="color:{rootFg}"
                                    onclick={() =>
                                        getCurrentWindow().minimize()}>─</button
                                >
                            {/if}
                ...
                {:else if el.type === 'Path' && el.props.svgFigures}
                    <svg
                        ...
                        style={buildStyle(el)}
                        viewBox="0 0 1 1"
                        preserveAspectRatio={el.props.svgStretch === 'Uniform'
                            ? 'xMidYMid meet'
                            : 'none'}
                        use:autoViewBox
                    >
                ...
                {:else if el.type === 'Image' || el.props.source}
                    ...
                    {#if el.props.source && !el.props.source.startsWith('__')}
                        <img
                            ...
                            class="absolute {imgObjectFit(el)} {el.props
                                .class ||
                                el.props.Class ||
                                ''}"
                            style={buildStyle(el)}
                ...
                {:else if el.type === 'TextBlock'}
                    <span
                        id={el.name}
                        class="absolute pointer-events-none leading-none {el
                            .props.class ||
                            el.props.Class ||
                            ''}"
                        style="
                            {buildStyle(el)}
                            color:{resolveBindingProp(el.props.Foreground) ||
                            rootFg};
                            {el.props.FontSize
                            ? `font-size:${el.props.FontSize}px;`
                            : ''}
                            {el.props.fontWeight
                            ? `font-weight:${el.props.fontWeight};`
                            : ''}
                            {el.props.FontFamily
                            ? `font-family:'${el.props.FontFamily}';`
                            : ''}
                            {el.props.textAlign
                            ? `text-align:${el.props.textAlign};`
                            : 'white-space:nowrap;'}
                        "
                        >{textValues[el.name ?? ''] ??
                            el.props.Text ??
                ...
                {:else if el.type === 'Border'}
                    <div
                        ...
                        style="
                            ...
                            : ''}
                            {el.props.CornerRadius
                            ? `border-radius:${el.props.CornerRadius}px;`
                            : ''}
                        "
                    ></div>
                {:else if el.type === 'Button'}
                    <button
                        id={el.name}
                        onclick={el.name === 'CancelButton' ||
                        el.props.Content === 'Cancel'
                            ? cancel
                            : undefined}
                        class="absolute cursor-pointer focus:outline-none {el
                            .props.class ||
                            el.props.Class ||
                            ''}"
                        style="
                ...
                {:else if el.type === 'ProgressBar'}
                    <div
                        class="absolute overflow-hidden {el.props.class ||
                            el.props.Class ||
                            ''}"
                        style="
                            {buildStyle(el)}
