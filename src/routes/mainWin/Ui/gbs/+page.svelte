...
<div class="flex flex-col gap-8">
        ...
        <div class="flex flex-col gap-3">
            <div class="flex flex-row gap-3">
                ...
                <SettingCard
                    ...
                    description={$_('pages.gbs.graphicsQualityLevel.description')}
                >
            ...
            <div class="flex flex-row gap-3">
                ...
                <SettingCard
                    ...
                    description={$_('pages.gbs.autoGeneratedGbsCard.description')}
                >
                    <Button
                        slot="footer"
                        variant="secondary"
    ...
    {:else}
        <p class="max-h-screen text-center">Woah! Current installation not found! You should at least click launch before checking this page out.</p>
    {/if}
</div>
