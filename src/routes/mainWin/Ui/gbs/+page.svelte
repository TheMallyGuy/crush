<script lang="ts">
    ...
    let currentInstallation:
        Awaited<ReturnType<typeof getCurrentInstallation>> | undefined =
        $state(undefined)
...
<div class="flex flex-col gap-8">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-3xl text-stone-100">
                {$_('pages.gbs.gbs')}
            </h1>
    ...
    {#if currentInstallation?.exists}
        <div class="flex flex-col gap-3">
            <div class="flex flex-row gap-3">
                ...
                >
                    {#snippet action()}<p>{graphicQuaity}</p>{/snippet}
                ...
                >
                    {#snippet footer()}
                        <Button
                            ...
                            >{$_(
                                'pages.gbs.autoGeneratedGbsCard.button'
                            )}</Button
                        >
                    {/snippet}
                </SettingCard>
